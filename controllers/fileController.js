...
class FileController {
    async createDir(req, res) {
        try {
            ...
            if (!parrentFile) {
                ...
                await fileService.createDir(req, file)
                parrentFile.childs.push(file.id)
    ...
    async getFiles(req, res) {
        try {
            ...
            console.log(e)
            return res.status(500).json({ msg: 'Can`t get files' })
        }
    }
    ...
    async downloadFile(req, res) {
        try {
            ...
            return res.status(400).json({ msg: "Download error" })
        } catch (e) {
            console.log(e)
    ...
    async search(req, res) {
        try {
            ...
            console.log(e)
            return res.status(400).json({ msg: 'Search error' })
        }
    } 
